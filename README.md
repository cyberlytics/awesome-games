...
- Metacritic:
	- [Best Games of All Time](https://www.metacritic.com/browse/game/)
	- [Best Games This Year](https://www.metacritic.com/browse/game/all/all/current-year/)
- OpenCritic:
	- [Best Games of All Time](https://opencritic.com/browse/all)
- IMDB:
	- [Top 100 Favorite Video Games of All Time](https://www.imdb.com/de/list/ls000012422/)
- The Game Awards:
	- [Nominees: GotY](https://thegameawards.com/nominees/game-of-the-year)
	- [Rewind](https://thegameawards.com/rewind)
- Wikipedia:
	- [List of video games considered the best](https://en.wikipedia.org/wiki/List_of_video_games_considered_the_best)
	- [List of GotY awards](https://en.wikipedia.org/wiki/List_of_Game_of_the_Year_awards)
	- [List of best-selling video games](https://en.wikipedia.org/wiki/List_of_best-selling_video_games)

## Open Source Games

- [Awesome Open Source Games #1](https://github.com/bobeff/open-source-games) by Ivan Bobev
- [Awesome Open Source Games #2](https://project-awesome.org/michelpereira/awesome-open-source-games) by Michael Pereira

## Abandonware

- [MyAbandonWare](https://www.myabandonware.com/game/)
- [HomeOfTheUnderdogs](https://homeoftheunderdogs.net/)
